...
-   استفاده از وبسایت‌های عمومی مانند [funda](https://www.funda.nl/) یا وبسایت خود املاکی‌ها که زیر لیستی از برخی از آنها آمده است:
    ...
    -   یکی از مهم‌ترین این agencyها [woonhave](https://woonhave.com/) است که معمولا خانه‌های خیلی خوبی دارند و خیلی وقت‌ها متاسفانه توی funda ثبت نمی‌کنند. 
...
**نکته:** اگر بدون قرارداد permanent آمده باشید، وقتی که تقریبا ۱ سال شد که به هلند مهاجرت کردید، حدود ۳ ماه مانده به اتمام تاریخ کارت اقامت، شرکت شما باید قرارداد را تمدید کند و به IND اطلاع دهد قصد ادامه همکاری دارد. (۳ ماه مانده خود IND هم نامه می‌زند برای یادآوری همین موضوع). ممکن است شرکت از این موضوع اطلاع نداشته باشد یا فراموش کند، پس حواستان به این مورد باشد.
...
**پی‌نوشت:** این قانون که می‌تونید مدرک تموم شدن دانشگاهتون رو بدید و بی‌افتید تو معافیت ۱ ساله و همچنان از کشور خارج شید، ظاهرا هر دفتر نظام وظیفه‌ای ازش اطلاع نداره! توی بعضی دفاتر تهران این رو قبول می‌کنن که شما برگه اتمام مدرک رو بدید و براتون مجوز خروج صادر کنن و بعضی جاها (مخصوصا شهرستان‌ها) ازش اطلاعی ندارن و باید برگه معرفی رو بفرستید و بعدش از کشور خارج شید. کلا سعی کنید هیچ وقت از سیستم دانشگاهی خارج نشید، ولی اگر شدید، این هم شدنیه که برگه سبز ارسال کنید و همچنان از کشور به عنوان سفر تفریحی خارج شید. 
</div>
