...
🗒️ لازم نیست چیزی رو یادداشت کنید در انتهای این صفحه یه [چیت‌شیت کامل](https://www.notion.so/9903e77e64344a67a45fab7e2bea1259) برای انجام قدم به قدم کار‌ها هست.
</div>
...
⚠️ شناسنامه، گواهینامه و سند ازدواج  به همراه ترجمه رسمی آنها را همراه با خود می بایست به سفارت برده و همانجا درخواست Legalize شدن آنها را بدهید. برای اطلاعات بیشتر به [بخش سوم: دریافت ویزا](https://docs.google.com/document/d/1gk3579-wDdDVns43o81Jkre8J8f6wWGJpcApgVaK5bY/edit#heading=h.91197vkdnzte) مراجعه کنید.
...
⚠️ حتما در این مرحله زمان ملاقات با IND را برای دریافت کارت اقامت خود در هلند انتخاب کنید. برای اطلاعات بیشتر به بخش [دریافت کارت اقامت](https://www.notion.so/9903e77e64344a67a45fab7e2bea1259) مراجعه کنید.

⚠️ حتما در این مرحله در صورت امکان، زمان ملاقات با شهرداری برای ثبت آدرس و دریافت BSN خود را در هلند انتخاب کنید. برای اطلاعات بیشتر به بخش [ثبت آدرس در شهرداری و دریافت BSN](https://www.notion.so/9903e77e64344a67a45fab7e2bea1259) مراجعه کنید.
...
توی انتخاب شرکت باید ببینید که چه شرکتی منطقه شمارو پوشش میده و قراردادش مناسب مصرفتون هست. جزئیات قیمت گذاری رو میتونید [اینجا](https://www.notion.so/Migration-to-Netherlands-doc-58704c1075f64a3db2a096df373569b4) بخونید.

برای اینترنت خونه باید با یکی از شرکت‌های اینترنت قرارداد ببندید. معمولا شرکتی که ازش سیم کارت میگید اگر اینترنت هم ارائه بده تخفیف خاصی میده اگر هردو سرویس رو بگیرید.
...
با استفاده از Digid میتونید درخواست بدید که پیغام‌های دولت(مثل مالیات و غیره) رو از طریق ایمیل بگیرید. برای فعال سازی به [این لینک](https://www.notion.so/9903e77e64344a67a45fab7e2bea1259) برید و با اکانت DigiD وارد بشید و تنظیم گرفتن پیغام از طریق ایمیل رو فعال کنید.
...
| ------------------------- | ---------------------------------------- | ---------------------------------------------------------------------------------- | ------------------------------------------------------------ |
| ترجمه مدارک               | شناسنامه، مدارک تحصیلی و غیره            | زمانی که تصمیم به شروع گرفتید                                                      | https://www.notion.so/1ae98d117b3c419fa82620dd7ff291ab       |
| درخواست اجازه کار از ind  | مدارک ترجمه شده و پاسپورت                | بعد از ترجمه مدارک                                                                 | https://www.notion.so/BSN-920fcb14b2b54b4fa1b36b78b35b2a06   |
| گرفتن وقت رجیستر کردن     | -                                        | وقتی زمان رسیدن مشخص شد. حداقل برای یک ماه بعد از رسیدن چون باید خونه داشته باشید. | https://www.notion.so/IND-509e0c79ff564663bbdd3b8d8986caab   |
| گرفتن وقت دریافت کارت ind | -                                        | وقتی زمان رسیدن مشخص شد. برای چند روز بعد از رسیدن وقت بگیرید                      | https://www.notion.so/1f6cbce90fb74075a9a1d0d154980e72       |
| گرفتن بلیط پرواز          | -                                        | وقتی زمان رسیدن مشخص شد                                                            | https://www.notion.so/010f05d42316482ebef261c45e19c65b       |
| پیدا کردن مکان سکونت موقت | -                                        | وقتی زمان رسیدن مشخص شد                                                            | https://www.notion.so/010f05d42316482ebef261c45e19c65b       |
| وقت سفارت                 | ارسال درخواست اجازه کار                  | بعد از ارسال فرم‌های ind برای زمان حدودی گرفتن جواب وقت بگیرید                     | https://www.notion.so/e9e19c0da04b445aa685eb5177f10290       |
| خرید سیم کارت هلندی       | پول                                      | به محض رسیدن به هلند                                                               | https://www.notion.so/5d0b79bfaad14534bbc308777634edf1       |
| کارت ov                   | پول نقد                                  | به محض رسیدن به هلند                                                               | https://www.notion.so/55b2b389da4f4a2d9b725cbe8357f8d5       |
| باز کردن حساب بانکی       | پاسپورت                                  | به محض رسیدن به هلند                                                               | https://www.notion.so/333c28244f3e42c8b8730a3a12e4a4c1       |
| پیدا کردن خانه            | سیم کارت‌‌ +‌ حساب بانکی +‌ قرارداد کاری | به محض رسیدن به هلند                                                               | https://www.notion.so/203d6a9ce9e847399650f6b0af705d07       |
| فعال کردن Digid           | BSN                                      | بعد از گرفتن نامه BSN                                                              | https://www.notion.so/DigiD-9944ce9d00df4b958acce9dde66173a1 |
| گرفتن بیمه                | BSN + آدرس                               | بعد از گرفتن BSN                                                                   | https://www.notion.so/7a74b888ff9446f7bbb2ab298937b213       |
| پیدا کردن GP              | بیمه                                     | بعد از گرفتن بیمه                                                                  | https://www.notion.so/GP-a81a1aeacd9442d3bfd16deab6d14cde    |
